...
router.get("/jobs", jwtAuth, (req, res) => {
  ...
  if (req.query.q) {
    findParams = {
      ...findParams,
      title: {
        $regex: new RegExp(req.query.q as string, "i"),
      },
    };
  }
  ...
  if (req.query.jobType) {
    ...
    if (Array.isArray(req.query.jobType)) {
      jobTypes = req.query.jobType as string[];
    } else {
      jobTypes = [req.query.jobType as string];
    }
    findParams = {
  ...
  if (req.query.salaryMin && req.query.salaryMax) {
    findParams = {
      ...
      $and: [
        {
          salary: {
            $gte: parseInt(req.query.salaryMin as string),
          },
        },
        {
          salary: {
            $lte: parseInt(req.query.salaryMax as string),
          },
        },
      ],
    };
  ...
  if (req.query.duration) {
    findParams = {
      ...findParams,
      duration: {
        $lt: parseInt(req.query.duration as string),
      },
    };
  }
  ...
  if (req.query.asc) {
    if (Array.isArray(req.query.asc)) {
      (req.query.asc as string[]).map((key) => {
        sortParams = {
          ...sortParams,
          [key]: 1,
        };
  ...
  if (req.query.desc) {
    if (Array.isArray(req.query.desc)) {
      (req.query.desc as string[]).map((key) => {
        sortParams = {
          ...sortParams,
          [key]: -1,
        };
...
router.get("/applicants", jwtAuth, (req, res) => {
  ...
  if (user.type === "recruiter") {
    ...
    if (req.query.jobId) {
      findParams = {
        ...findParams,
        jobId: new mongoose.Types.ObjectId(req.query.jobId as string),
      };
    }
    if (req.query.status) {
